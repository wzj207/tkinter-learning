...
def update():
    ...
    record_id = delete_entry_box.get()
...
def edit():
    ...
    editor.iconbitmap('./images/favicon.ico')  # add icon
...
def delete_record():
    ...
    # Delete a record
    c.execute("DELETE from address WHERE oid = " + delete_entry_box.get())
...
delete_entry_box = Entry(root, width=30)
delete_entry_box.grid(row=9, column=1, pady=5)
